...
covar2<-read.table("../Data/curry_covariates.txt",header=TRUE)
...
curry = read.table("del_curry.txt",header=TRUE)
#covar = covar[,-3]
curry[, 3] = curry[, 3]/250 
curry[, 4] = curry[, 4]/235 - 39/47
